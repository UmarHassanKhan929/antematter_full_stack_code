...
io.on("connection", (socket: Socket) => {
  ...
  socket.on("question", (question: string) => {
    ...
    const answer =
      jsonStore[question] ?? "Sorry, I don't know the answer to that question."
